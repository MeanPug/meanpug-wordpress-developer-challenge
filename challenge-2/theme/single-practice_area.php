    ...
    <?php if (have_posts()):
        while (have_posts()):
            ...
            <article class="container max-w-4xl mx-auto">
                ...
                <section class="mt-12 mb-12 border-t pt-8">
                    <?php if ($featured_attorneys): ?>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <?php foreach ($featured_attorneys as $attorney):
                                ...
                                ?>
                                <div
                                    class="flex items-center p-4 bg-gray-50 border border-gray-100 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                                    ...
                                    <div>
                                        ...
                                        <a href="<?php echo get_permalink($attorney->ID); ?>"
                                            class="text-xs text-gray-500 hover:text-blue-900 mt-1 inline-block uppercase font-bold tracking-tighter">View
                                            Profile →</a>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                    ...
                    <?php else: ?>
                        ...
                        <?php if (current_user_can('manage_options')): ?>
                            <div class="p-6 border-2 border-dashed border-amber-200 bg-amber-50 rounded-xl">
                                <p class="text-sm text-amber-700 font-bold flex items-center gap-2">
                                    <span>⚠️ Admin:</span> No specialists linked to this practice area. Please use the ACF relationship
                                    field.
                                </p>
                            </div>
                        <?php else: ?>
                            <p class="text-sm italic text-gray-400">Our specialist team for this area is being updated. Contact us for
                                more information.</p>
                        <?php endif; ?>
                    <?php endif; ?>
                </section>
                ...
                <footer
                    class="mt-12 p-8 bg-blue-900 rounded-lg text-white flex flex-col md:flex-row items-center justify-between">
                    <div>
                    ...
                    <a href="/contact"
                        class="mt-6 md:mt-0 bg-yellow-400 text-blue-900 font-bold py-3 px-8 rounded-full hover:bg-yellow-300 transition-colors uppercase tracking-widest text-sm">
