...
<main id="primary" class="site-main">
        ...
        <div class="max-w-screen-3xl mx-auto">
            ...
            <div class="relative">
                <ul role="tablist"
                    ...
                    <li role="tab" aria-selected="true"
                        class="cursor-pointer flex items-center gap-2 pb-1 border-b-2 border-airbnb-text">
                        Places to stay
                    </li>
                    <li role="tab"
                        class="cursor-pointer flex items-center gap-2 pb-2 border-transparent">
                        Monthly stays
                    </li>
                    <li role="tab"
                        class="cursor-pointer flex items-center gap-2 pb-2 border-transparent">
            ...
            <form action="#" method="get" role="search"
                ...
                <label class="flex-1 flex flex-col justify-center px-5 py-1 rounded-md hover:bg-airbnb-soft transition-colors cursor-pointer">
                    <span class="text-xs font-bold uppercase tracking-wide text-airbnb-text">Location</span>
                ...
                <label class="flex-1 flex flex-col justify-center px-5 py-1 rounded-md hover:bg-airbnb-soft transition-colors cursor-pointer">
                    <span class="text-xs font-bold uppercase tracking-wide text-airbnb-text">Check in / Check out</span>
                ...
                <label class="flex-1 flex flex-col justify-center px-5 py-1 rounded-md hover:bg-airbnb-soft transition-colors cursor-pointer">
                    <span class="text-xs font-bold uppercase tracking-wide text-airbnb-text">Guests</span>
                    <input type="text" name="guests" placeholder="Add pugs"
                           class="bg-transparent border-0 p-0 mt-0.5 text-sm text-airbnb-muted placeholder:text-airbnb-muted focus:outline-none focus:ring-0 w-full">
                </label>

                <button type="submit"
                        class="mt-2 md:mt-0 md:ml-1.5 flex items-center justify-center gap-2 bg-airbnb-pink hover:bg-airbnb-pink-dark text-white font-bold text-base rounded-md px-4 py-2 md:py-0 transition-colors">
    ...
    <!-- Featured cards -->
    <section class="max-w-full mx-auto px-4 sm:px-6 lg:px-10 pb-20" aria-label="Featured destinations">
        <div class="max-w-screen-3xl mx-auto px-4 sm:px-6 lg:px-0 pb-20" aria-label="Featured destinations">
